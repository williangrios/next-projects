        ...
        <div className="w-full">
            <div className="p-4 md:pt-8 flex flex-col md:flex-row items-center content-center max-w-6xl mx-auto md:space-x-6">
                <Image src={`https://image.tmdb.org/t/p/original/${
                    ...
                    }`} width={500} height={300} alt={`movie poster`} style={{maxWidth: "100%", height: "100%"}} className="rounded-lg">
                </Image>
                <div className="p-2">
                    ...
                    <p className="mb-3"><span className="font-semibold mr-1">Likes:</span>{movie.vote_count}</p>
                </div>
            </div>
        </div>
    )
